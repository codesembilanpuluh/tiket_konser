	...
	<div class="container-fluid">
		<div class="card card-primary card-outline">
			<div class="card-header">
                <h3 class="card-title"><i class='fa fa-folder-open'></i> Ubah Data Kategori</h3>
				</div>
			<div class="card-body">
                ...
                <form class="form-horizontal" id="data_form">
					...
					<div class="form-group row">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" name="kategori" id="kategori" value="{{$result->kategori}}" placeholder="Kategori">
						</div>
					</div>
					...
					<div class="form-group row">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" name="harga" id="harga" value="{{$result->harga}}" placeholder="Harga">
						</div>
					</div>
...
<script>
	$('#data_form').on('submit', function(event) {
		...
		$.ajax({
			type	: "POST",
			dataType: "json",
			url		: "{{asset('admin/kategori/'.$result->id)}}",
			data	: idata,
			processData: false,
			contentType: false,
			cache 	: false,
